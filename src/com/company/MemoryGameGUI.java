...
public class MemoryGameGUI extends JFrame 
{
  ...
  public String playSequence(String[] sequence, double delay)
  {
    ...
    for (int i = 0; i < sequence.length; i++ )
    {
      ...
      // Create a random red value
      int randRed = (int) (Math.random() * (255 - 50) + 50);
      // Create random Green value
      int randGreen = (int) (Math.random() * (255 - 50) + 50);
      // Create random blue value.
      int randBlue = (int) (Math.random() * (255 - 1) + 1);
      gameButtons[buttonNum].setBackground(new Color(randRed, randGreen, randBlue));
